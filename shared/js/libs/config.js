(function (shoptet) {
  ...
  shoptet.config.animationDuration =
    typeof shoptet.custom.config.animationDuration !== 'undefined' ? shoptet.custom.config.animationDuration : 300;

  shoptet.config.submenuTimeout =
    typeof shoptet.custom.config.submenuTimeout !== 'undefined' ? shoptet.custom.config.submenuTimeout : 150;

  shoptet.config.dismissTimeout =
    typeof shoptet.custom.config.dismissTimeout !== 'undefined' ? shoptet.custom.config.dismissTimeout : 6000;

  shoptet.config.updateQuantityTimeout =
    typeof shoptet.custom.config.updateQuantityTimeout !== 'undefined'
      ? shoptet.custom.config.updateQuantityTimeout
      : 1000;

  shoptet.config.adminBarTimeout =
    typeof shoptet.custom.config.adminBarTimeout !== 'undefined' ? shoptet.custom.config.adminBarTimeout : 800;

  shoptet.config.image360RotationSpeed =
    typeof shoptet.custom.config.image360RotationSpeed !== 'undefined'
      ? shoptet.custom.config.image360RotationSpeed
      : 100;
