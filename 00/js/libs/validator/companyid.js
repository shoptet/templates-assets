(function (shoptet) {
  function validateCompanyId(el) {
    ...
    if (regex && validatedValue && !regex.test(validatedValue)) {
      shoptet.validator.addErrorMessage(el, shoptet.validatorCompanyId.messageTypeCustomized);
  ...
  function updateCompanyIdValidPattern() {
    ...
    if (currentOption.length) {
      ...
      shoptet.messages[shoptet.validatorCompanyId.messageTypeCustomized] = shoptet.messages[
        shoptet.validatorCompanyId.messageType
