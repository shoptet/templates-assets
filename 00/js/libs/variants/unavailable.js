(function (shoptet) {
      ...
      if (existing.hasOwnProperty(param)) {
        ...
        if (!available.hasOwnProperty(option.value)) {
          ...
          if (el.tagName === 'SELECT') {
            ...
            option.parentElement.classList.add(shoptet.variantsUnavailable.classes.unavailableOptionWrapper);
          }
        } else {
          ...
          if (el.tagName === 'SELECT') {
            ...
            option.parentElement.classList.remove(shoptet.variantsUnavailable.classes.unavailableOptionWrapper);
          }
        }
      }
    }
  ...
  shoptet.scripts.libs.variantsUnavailable = [
    'setupAllParameters',
