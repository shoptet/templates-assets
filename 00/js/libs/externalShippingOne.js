(function (shoptet) {
  ...
  var myShippingName = 'externalShippingOne';
  ...
  document.addEventListener('ShoptetBaseShippingInfoObtained', function () {
    console.log('%cdeliveryCountryId: ' + shoptet.checkoutShared.deliveryCountryId, 'color: violet;');
    console.log('%cregionCountryId: ' + shoptet.checkoutShared.regionCountryId, 'color: violet;');
    console.log('%ccurrencyCode: ' + shoptet.checkoutShared.currencyCode, 'color: violet;');
