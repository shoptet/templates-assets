(function (shoptet) {
  ...
  function replaceImage(bigImage) {
    ...
    const matchingThumbnail = [...document.querySelectorAll('.p-thumbnails-inner .p-thumbnail')].find(
      thumbnail => thumbnail.getAttribute('href') === bigImage
    );
  ...
  function setStyle($selector) {
    $selector.removeClass('star-off').addClass('star-on').prevAll().removeClass('star-off').addClass('star-on');
